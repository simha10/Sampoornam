...
import { XMarkIcon, PlusIcon, MinusIcon, TrashIcon, CheckCircleIcon } from "@heroicons/react/24/outline";
                                ...
                                {isCheckout ? (
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 rounded-full bg-brand-gold py-3.5 text-sm font-bold text-[#0a0a0a] transition-all hover:bg-[#F5E6A3] disabled:opacity-50"
                                        >
    ...
    return (
        <div className="flex h-full flex-col items-center justify-center text-center px-4">
            ...
            <motion.div
                ...
                className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-green-500/15"
            >
            ...
            >
                Order ID: <span className="font-semibold text-brand-gold">{orderNumber}</span>
            </motion.p>
            ...
            <motion.p
                ...
                className="mt-4 text-sm leading-relaxed text-white/40 max-w-xs"
            >
                Send a WhatsApp message to help the Sampoornam Kitchen prepare your order faster!
            </motion.p>
            ...
            <motion.button
                ...
                className="mt-6 flex w-full max-w-xs items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 py-3.5 text-sm font-bold text-white transition-all hover:bg-[#20BD5A] active:scale-[0.98]"
            >
            ...
            <motion.button
                ...
                onClick={onDismiss}
                className="mt-3 w-full max-w-xs rounded-full border border-white/15 px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-white/5"
            >
                Continue Shopping
            </motion.button>
        </div>
