                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-4">
                            {items.length === 0 ? (
                                ...
                                <div className="flex flex-col gap-4">
                                    <h3 className="text-sm font-bold tracking-wider text-[#D4AF37] uppercase">
                                        Delivery Details
                                    </h3>
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Full delivery address in Lucknow"
                                            rows={3}
                            ...
                            <div className="border-t border-white/[0.06] px-6 py-4">
                                ...
                                {isCheckout ? (
                                    ...
                                    <button
                                        ...
                                        className="w-full rounded-full bg-[#D4AF37] py-3.5 text-sm font-bold tracking-wider text-[#0a0a0a] uppercase transition-all hover:bg-[#F5E6A3] active:scale-[0.98]"
                                    >
                                        Proceed to Checkout
                                    </button>
                                )}
...
function CartItemRow({
    ...
    return (
        <div className="flex items-start gap-4 rounded-2xl border border-white/[0.04] bg-white/[0.02] p-4">
            <div className="flex-1">
                ...
                <div className="mt-3 flex items-center gap-3">
                    <button
                        ...
                        className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.06] text-white/60 transition-colors hover:bg-white/10"
                    >
